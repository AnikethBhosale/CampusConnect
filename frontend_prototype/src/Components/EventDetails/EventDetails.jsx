        ...
        <div className="container1-body">
          <div className="body-head">
            ...
            <div className="head1-text">
              <h2 className='event-details-title'> Hosted By:</h2>
              <h2 className='event-details-title'>{post.eventorganizer}</h2>
            </div>
          </div>
          <div className="body1-content">
            ...
            <div className="event-date-time"><h2>Date: {post.eventdate}  <label>&#160;   Time: </label>{post.eventstime}</h2></div>
            <div className="event-location"><h2>Location: {post.eventvenue}</h2></div>

            <div className="event-description">
              <h3 className='event-details-title'>Event Description</h3>
