        ...
        <div className="createri-body">
            <div className="createri-body-head">
                ...
                <div className="createri-head1-text">
                   ...
                   <select value={postDetails.eventorganizer} onChange={changeHandler} name='eventorganizer' placeholder='Type here'>
            ...
            <div className="createri-body1-content">
                <div className="createri-body-info">
                   ...
                   <input value={postDetails.eventname} onChange={changeHandler} type="text" id="event-name" name="eventname" placeholder="Type your event name..."></input>
                   <hr></hr>
                   <label>Event info</label> 
                   <textarea value={postDetails.eventinfo}onChange={changeHandler} type="textarea" name='eventinfo' placeholder='Type here'></textarea>
                </div>
                <div className="createri-date-time">
                    <div className='createri-time'>
                    <label>Select date and time</label>
                    <h3>From:</h3>
                    <input value={postDetails.eventstime} onChange={changeHandler} type="text" id="event-time" name="eventstime" placeholder='HH:TT'></input>
                    <h3>To:</h3>
                    <input value={postDetails.eventetime} onChange={changeHandler} type="text" id="event-time" name="eventetime" placeholder='HH:TT'></input>
                    </div>
                    <div className='createri-date'>
                        <label>Select Date</label>
                    <input value={postDetails.eventdate} onChange={changeHandler} type="text" id="event-date" name="eventdate" placeholder='dd-mm-yyyy'></input>
                    </div>
                </div>
                <div className="createri-location">
                    <label>Location input</label>
                    <input value={postDetails.eventvenue} onChange={changeHandler} type="text" id="location" name="eventvenue" placeholder="Type your location..."></input>
                </div>
                ...
                <div className="createri-event-description">
                    ...
                    <textarea value={postDetails.eventdescription} onChange={changeHandler} type="textarea" name='eventdescription' placeholder='Type here'></textarea>
                </div>
                <div className='createri-event-button'>
                    <button onClick={()=>{AddPost()}}><h2>Create</h2></button>
                </div>
            </div>
        </div>
    </div>
